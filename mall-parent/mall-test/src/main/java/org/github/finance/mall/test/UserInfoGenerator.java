...
/**
 * @author ligaofeng 2017年1月16日 下午3:28:01
 */
public class UserInfoGenerator {
    ...
    public static String getEmail(int lMin, int lMax) {
        ...
        for (int i = 0; i < length; i++) {
            int number = (int) (Math.random() * UserBase.base.length());
            sb.append(UserBase.base.charAt(number));
        }
        sb.append(UserBase.email_suffix[(int) (Math.random() * UserBase.email_suffix.length)]);
        return sb.toString();
    }
    ...
    private static String getChineseName() {
        int index = getNum(0, UserBase.firstName.length() - 1);
        String first = UserBase.firstName.substring(index, index + 1);
        int sex = getNum(0, 1);
        String str = UserBase.boy;
        int length = UserBase.boy.length();
        if (sex == 0) {
            str = UserBase.girl;
            length = UserBase.girl.length();
            name_sex = "女";
        } else {
            name_sex = "男";
        }
    ...
    private static String getRoad() {
        int index = getNum(0, UserBase.road.length - 1);
        String first = UserBase.road[index];
